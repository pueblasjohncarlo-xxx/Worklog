...
Route::middleware(['auth', 'verified', 'role:coordinator'])->group(function () {
    ...
    Route::get('/coordinator/assignments', [CoordinatorController::class, 'assignmentsIndex'])->name('coordinator.assignments.index');
    Route::post('/coordinator/assignments', [CoordinatorController::class, 'assignmentsStore'])->name('coordinator.assignments.store');
    Route::patch('/coordinator/assignments/{assignment}/hours', [CoordinatorController::class, 'updateRequiredHours'])->name('coordinator.assignments.update-hours');
