                            ...
                            @forelse($rows as $row)
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/20">
                                    ...
                                    <td class="px-4 py-4 text-right">
                                        <a href="{{ route('ojt_adviser.mopping.show', ['assignment' => $assignment->id, 'month' => $monthKey]) }}" class="inline-flex items-center px-3 py-2 rounded-md bg-gray-900 text-white text-sm font-semibold hover:bg-black">
                                            View
                                        </a>
                                    </td>
                                </tr>
