                                    ...
                                    @forelse($arLogs as $log)
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-sm text-right space-x-2">
                                                <a href="{{ route('ojt_adviser.worklogs.print', $log->id) }}" class="text-indigo-700 dark:text-indigo-300 font-semibold hover:underline">View</a>
                                                @if($log->attachment_path)
                                                    <a href="{{ route('ojt_adviser.worklogs.attachment', $log->id) }}" class="text-gray-700 dark:text-gray-300 font-semibold hover:underline">Download</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @empty
