    ...
    <div class="space-y-6" x-data='{
        ...
        <template x-if="selectedAdviserId && selectedAdviser()">
            <div x-transition>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 p-6">
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                            <p class="text-xs font-semibold text-blue-600 dark:text-blue-300 uppercase tracking-wider">Total OJT Students</p>
                        ...
                        <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
                            <p class="text-xs font-semibold text-green-600 dark:text-green-300 uppercase tracking-wider">Active OJT Students</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">OJT Student Roster</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <!-- Search -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Search OJT Student</label>
