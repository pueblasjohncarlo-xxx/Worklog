            ...
            <div class="p-6 text-gray-900 dark:text-gray-100 space-y-4">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <form method="GET" class="flex items-center gap-2">
                        ...
                        <a href="{{ route('coordinator.mapping.index', ['month' => $monthKey]) }}" class="px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100 text-sm font-semibold">Back</a>
                    </form>
                </div>
