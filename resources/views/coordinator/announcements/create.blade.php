<x-coordinator-layout>
    ...
    <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('coordinator.announcements.store') }}" class="space-y-6" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex items-center justify-end mt-4">
                <a href="{{ route('coordinator.announcements.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 underline mr-4">
                    Cancel
                </a>
                <x-primary-button>
