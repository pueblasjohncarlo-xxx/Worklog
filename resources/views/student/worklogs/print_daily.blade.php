...
<head>
    ...
    <title>{{ ucfirst($report->type) }} Accomplishment Report - {{ $student->name }}</title>
    <style>
        @page {
            size: A4;
            margin: 0;
...
<body>
    ...
    <div class="page-container" id="reportContent">
        ...
        <div class="report-title">
            ...
            <div class="report-title-sub">Daily Accomplishment Report</div>
        </div>
        ...
        <table class="info-table">
            <tr>
                ...
                <td style="width: 45%;">
                    <span class="info-label">Course:</span> <span class="info-value">{{ $student->section ?? 'N/A' }}</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <span class="info-label">Major:</span> <span class="info-value">{{ $student->department ?? 'N/A' }}</span>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="info-label">Company's Name:</span> <span class="info-value">{{ optional($assignment->company)->name }}</span>
                </td>
                <td>
                    <span class="info-label">Mobile Number:</span> <span class="info-value">{{ optional($student->studentProfile)->phone ?? 'N/A' }}</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <span class="info-label">Date:</span> <span class="info-value">{{ $report->work_date->format('F d, Y') }}</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <span class="info-label">Weekly Total Hours:</span> <span class="info-value">&nbsp;</span>
                </td>
            </tr>
        </table>
            ...
            <tbody>
                @for ($i = 0; $i < 9; $i++)
                    <tr>
                        ...
                        <td style="height: 22px; padding: 6px 8px;">&nbsp;</td>
                ...
                @endfor
                <tr class="row-total">
                    <td colspan="4" style="text-align: right; border-right: none;">TOTAL HOURS</td>
                    <td style="text-align: center; border-left: none; border-right: none;">&nbsp;</td>
                    <td style="text-align: center; border-left: none; text-transform: uppercase;">&nbsp;</td>
                </tr>
                <tr class="row-total" style="background-color: #2b5797; color: #fff;">
                    <td colspan="4" style="text-align: right; border-right: none; font-weight: bold;">TOTAL WEEKLY HOURS</td>
                    <td style="text-align: center; border-left: none; border-right: none; font-weight: bold;">&nbsp;</td>
                    <td style="text-align: center; border-left: none; text-transform: uppercase; font-weight: bold;">&nbsp;</td>
                </tr>
            </tbody>
        </table>
                ...
                <tr>
                    <td>
                        <div class="sig-line-container" style="margin-top: 15px;">
                            ...
                            <span class="sig-label-bottom">CDT OJT Adviser's Signature over Printed Name</span>
                        </div>
                    </td>
                    <td>
                        <div class="date-line-container">
                ...
                <tr>
                    <td>
                        ...
                        <div class="sig-line-container">
                            ...
                            <span class="sig-label-bottom">College Dean's Signature over Printed Name</span>
                        </div>
                    </td>
                    <td>
                        <div class="date-line-container">
    ...
    <script>
        function exportToDoc() {
            ...
            "<head><meta charset='utf-8'><title>Daily Accomplishment Report</title>" +
            "<style>" +
            ...
            link.download = "Daily_Accomplishment_Report_" + dateStr + ".doc";
