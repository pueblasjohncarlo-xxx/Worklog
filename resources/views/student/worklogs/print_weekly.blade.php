...
<head>
    ...
    <title>Weekly Accomplishment Report - {{ $student->name }}</title>
    <style>
        @page {
            size: A4;
            margin: 0;
...
<body>
    ...
    <div class="page-container" id="reportContent">
        ...
        <div class="report-title">
            ...
            <div class="report-title-sub">Weekly Accomplishment Report</div>
        </div>
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td>
                    <span class="info-label">Date:</span> <span class="info-value">{{ $report->work_date->format('M d, Y') }}</span>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <script>
        function exportToDoc() {
            ...
            "<head><meta charset='utf-8'><title>Weekly Accomplishment Report</title>" +
            "<style>" +
            ...
            link.download = "Weekly_Accomplishment_Report_" + dateStr + ".doc";
