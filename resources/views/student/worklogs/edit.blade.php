                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    readonly
                                    class="block w-full rounded-2xl border-gray-200 dark:border-gray-700 bg-indigo-50/50 dark:bg-indigo-900/10 text-indigo-600 dark:text-indigo-400 shadow-sm transition-all py-4 px-6 font-black"
                                >
