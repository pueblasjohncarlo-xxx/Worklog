...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="worklog-ui-hardening font-sans antialiased bg-gradient-to-br from-purple-900 via-indigo-950 to-black text-gray-100 min-h-screen bg-fixed overflow-x-hidden">
