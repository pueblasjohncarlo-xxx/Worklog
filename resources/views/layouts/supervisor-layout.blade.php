...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'WorkLog') }} - Supervisor</title>
    ...
    <body class="font-sans antialiased bg-gradient-to-br from-purple-900 via-indigo-950 to-black text-gray-100 min-h-screen bg-fixed shimmer-bg">
        ...
        <script>
            ...
            const supervisorSidebar = document.querySelector('[x-data*="mobileOpen"]');
            document.addEventListener('toggle-sidebar', () => {
                if (supervisorSidebar && supervisorSidebar.__x) {
                    supervisorSidebar.__x.unobservedData.mobileOpen = !supervisorSidebar.__x.unobservedData.mobileOpen;
                }
            });
        </script>
    </body>
